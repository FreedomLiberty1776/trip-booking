!(function () {
	...
	(Inline.prototype.setTransaction = function (t) {
		...
		(Inline.prototype.createButton = function () {
			...
			e.defaults.customButton
				...
				: (((t = document.createElement("button")).innerHTML =
						"<span class='paystack-top-blue'>Pay Securely with Paystack</span><span class='paystack-body-image'> </span>"),
		...
		(Inline.prototype.handleOldCheckoutEvents = function (t) {
			...
			if (n && ("string" == typeof n || n instanceof String)) {
				...
				"PaystackTLSClose" == r.action &&
					(e.defaults.tlsFallback.call(this), e.isEmbed || e.closeOldCheckout());
			}
		}),
	...
	var PaystackPop = {
			...
			setup: function (t, e) {
				...
				if (isValid(r)) {
					if ((this.isInitialized ? ca.setTransaction(r) : this.initialize(r), !e))
						return ca;
	...
	function parseResponse(t, e) {
		...
		return (
			...
			n &&
				((i = (r = t.split(" "))[1]), (a = r.slice(2).join(" ")), (o = e.id == i)),
			...
			void 0 !== u.addEventListener
				...
				: void 0 !== u.attachEvent &&
				  u.attachEvent("onload", function () {
						...
						try {
							for (; e--; )
								if ((t = document.styleSheets[e]).id === r) return t.cssText, void d();
						} catch (t) {}
						s || l();
				  }),
		...
		function g() {
			return (
				...
				(this.text = function () {
					...
					if (this._bodyBlob)
						return (
							(t = this._bodyBlob), (n = y((e = new FileReader()))), e.readAsText(t), n
						);
					if (this._bodyArrayBuffer)
	...
	(function (t, e) {
		...
		JavascriptChannel.postMessage("trigger");

		//console.log("done with setup");
	});

// assuming this is the information provided for the booked seat
// trip_info = {
// 	account_id: "+233557494701",
// 	name: "Emmanuel Adu",
// 	contact: "0557494701",
// };

// user_id = "+233557494701";

// userId replaces the seat ("0") in the array
// seats = [
// 	"0",
// 	"0",
// 	"+233557494701",
